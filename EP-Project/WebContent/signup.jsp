            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="border-radius: 5px;">
                        <form id="login-form" class="form" name="signup" action="SignUp" method="post" onsubmit="return validate()">
                            <h3 class="text-center text-info"><i class="fas fa-user-plus"></i> <b> Add Account </b> </h3>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phnum" placeholder="Phone Number" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dept" placeholder="Department" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="pos" class="text-info"><i class="fas fa-user-tag"></i> Position:</label><br>
                                <input type="text" name="pos" placeholder="Designation" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-info"><i class="fa fa-user-plus" aria-hidden="true"></i> <b> Add Account </b> </button>
                            </div>
                        </form>
                    </div>
                </div>
